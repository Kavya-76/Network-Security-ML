...
class TrainingPipeline: 
    ...
    def start_data_ingestion(self):
        try:
            self.data_ingestion_conifg = DataIngestionConfig(training_pipeline_config=self.training_pipeline_config)
            logging.info("Start data ingestion")

            data_ingestion = DataIngestion(data_ingestion_config=self.data_ingestion_conifg)
