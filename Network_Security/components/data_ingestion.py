...
if not MONGO_DB_URL:
    raise NetworkSecurityException("MONGO_DB_URL is not set in environment.", sys)
...
class DataIngestion: 
    ...
    def export_collection_as_dataframe(self):
        try:
            logging.info("Exporting collection from MongoDB to DataFrame...")
    ...
    def export_data_into_feature_store(self,dataframe: pd.DataFrame):
        try:
            ...
            logging.info(f"Saved feature store at {feature_store_file_path}")
            return dataframe
